...
tx.toast("Hello Great Hacker 🤗") 


g = tx.alert("\n────────────────────────────💚 Made A T0X1C - V$XV Script 💚\n────────────────────────────\n🖤 Thank You So Much - Wuxin 🖤\n────────────────────────────\n🏴󠁧󠁢󠁥󠁮󠁧󠁿ENG |👌 Welcome to my script, thanks for buying, good game.\n────\n🇷🇺RU |👌 Добро пожаловать в мой скрипт, спасибо большое за покупку, хорошей вам игры. \n────────────────────────────\n✅ The Script Was Tested On Poco F1 With Root Rights\n────────────────────────────\n♻️ Powered By GG T0X1C ♻️","END", "", "EXIT" ) 
if g == 1 then 
elseif g == 2 then 
elseif g == 3 then
print("─────────────────────────────────────\n💎 V$XV Hack - By T0X1C 💎\n─────────────────────────────────────\n💜 Subscribe My Channel\n────\n✅ Telegram - @T0X1CCF\n\n✅ YouTube - T0X1C\n─────────────────────────────────────\n💚 Subscribe My Friend Wuxin\n────\n✅ Telegram: @wuxin9999hack\n─────────────────────────────────────")
...
function F4() 
FC = tx.alert("Love You", "Вкл", "Выкл","Назад" )
  if FC == 1 then
    tx.clearResults()
    tx.setRanges(32)
...
function F3()
FC = tx.alert("Love You","Выкл","Вкл","Назад")
if FC == 3 then 
S1() 
    elseif FC == 2 then
qmnb = {
...
function F2()
FC = tx.alert('Love You', 'Белый Персонаж', 'ВЫКЛ', 'ВХ')
  if FC == 1 then
qmnb = {
{["memory"] = 32},
{["name"] = "ON"},
...
AU = tx.choice({
	...
	"✅ Telegram General", 
	"✅ Telegram Chat", 
	"✅ Telegram Last Island Of Survival", 
	"✅ Telegram Pubg Mobile", 
	"✅ Telegram Standoff 2", 
	"✅ Telegram Free Fire",
	"✅ Tik Tok", 
	"✅ Wuxin", 
	"🔙 BACK "
	},nil, "ℹ️ Menu Author ℹ️\n⚠️ Click on the button to copy the link ⚠️" ) 
...
FC = tx.alert("Walking Under Water", "Вкл", "Выкл","Назад" )
